    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 ">
               <h3 class=" pr-2"> <i class="fas fa-envelope-square email "></i>ckatarsis2020@gmail.com</h3>
               <h3 ><i class="fab fa-whatsapp-square what"></i>+52 646 83 85 44</h3>

            </div>
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <a class="face "  href=""><i class=" fab fa-facebook-square"></i></a>
                <a class="instagram" href=""><i class="fab fa-instagram-square"></i></a>
                <a class="youtube" href=""><i class="fab fa-youtube"></i></a>
                <a class="tiktok" href=""><i class="fab fa-tiktok"></i></a>
            </div>
     @auth
